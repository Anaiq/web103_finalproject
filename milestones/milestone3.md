...
Learned how to use github projects, issues for the first time.
...
Board Interactivity:  Instead of animating the board on slection, maybe just add X and O or a prompt that  indicates correct/incorrect answers.
